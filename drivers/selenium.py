...
class Selenium:
    ...
    def selenium_forward_browser(self):
        """
        前进到下一级页面
        """
    ...
    def context_click(self, by, value, index, name):
        """
        selenium 右击事件
        :param by: 元素属性
        :param value: 元素内容
    ...
    def double_click(self, by, value, index, name):
        """
        selenium 双击事件
        :param by: 元素属性
        :param value: 元素内容
    ...
    def move_element(self, by, value, index, name):
        """
        selenium 鼠标悬停事件
        :param by: 元素属性
        :param value: 元素内容
